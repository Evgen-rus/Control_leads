...
Тест также проверит эффективность оптимизации для больших таблиц.
...
- **Анализирует только недавние данные** (по умолчанию за последний день)
